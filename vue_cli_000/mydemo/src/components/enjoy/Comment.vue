<template>
  <div>
    ...
    <div class="a1">
      <p>五星好评待开发...</p>
    <textarea placeholder="请输入您的评论..." name="msg" cols="20" rows="5" maxlength="80" v-model="commentInput"></textarea>
    </div>
    <!-- 图片上传预览区 -->
...
export default {
  ...
  methods: {
    ...
    //  获取照片名称
      ...
      var obj=`str=${commentInput}&fils=${fils}`
  ...
  mounted () {//挂在DOM树后 既有Data对象，又有虚拟DOM树，即可发送ajax请求，有课执行DOM操作 重要
